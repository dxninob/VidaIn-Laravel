  ...
  <div class="container">
    <div class="row justify-content-center">
      <div class="pad col-md-15">
        <h3>Progreso: 72%</h3>
        <div class="progressbar" id="progressbar10">
          <div></div>
        </div>
        <form action="{{ route('test.save') }}" method="POST">
          ...
          <table class="table custom-table">
            ...
            <tbody>
              ...
              <tr scope="row">
                ...
                @if($question->id == 28 || $question->id == 30)
          ...
          <div class="row mb-0">
            <div class="button">
              <button type="submit" class="btn btn-primary bg-secondary" style="float: right;" name="index10" value="10">{{ __('Siguiente') }}</button>
            </div>
          </div>
        </form>
      </div>
