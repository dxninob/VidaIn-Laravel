            ...
            <form action="{{ route('test.save') }}" method="POST">
                ...
                <table class="default">
                    ...
                    <tr>
                        ...
                        <td style="text-align:center"><input id="0" type="radio" name="{{ $question->id }}" value="0" required/></td>
                        <td style="text-align:center"><input id="1" type="radio" name="{{ $question->id }}" value="1"/></td>
