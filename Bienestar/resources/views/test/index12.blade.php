  ...
  <div class="container">
    <div class="row justify-content-center">
      <div class="pad col-md-15">
        <h3>Progreso: 88%</h3>
        <div class="progressbar" id="progressbar12">
          <div></div>
        </div>
        <form action="{{ route('test.save') }}" method="POST">
          ...
          <div class="row mb-0">
            <div class="button">
              <button type="submit" class="btn btn-primary bg-secondary" style="float: right;" name="index12" value="12">{{ __('Siguiente') }}</button>
            </div>
          </div>
        </form>
      </div>
