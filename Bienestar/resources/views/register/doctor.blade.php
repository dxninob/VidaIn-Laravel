    ...
    <div class="row justify-content-center">
        ...
        <div class="card-body">
            <form method="POST" action="{{ route('register') }}">
                ...
                <div class="row mb-3">
                    <label for="entity" class="col-md-4 col-form-label text-md-end">{{ __('Entidad para la que trabaja') }}</label>

                    <div class="col-md-6">
                        <input id="entity" type="text" class="form-control @error('entity') is-invalid @enderror" name="entity" value="{{ old('entity') }}" required autocomplete="entity" autofocus>
                    </div>
                </div>

                <div class="row mb-3">
                    <label for="profession" class="col-md-4 col-form-label text-md-end">{{ __('Cargo (profesión/especialidad)') }}</label>
